...
%
\setcounter{section}{1}   % put in your section here.
\setcounter{subsection}{10} % set to your subsection or (subsection-1 if writing at the subsection level).
